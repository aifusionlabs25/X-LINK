...
# Map slugs to the correct high-fidelity history files (Hand-verified)
FILES = {
    'morgan': 'morgan_20260327_173848.txt',
    'sarah-netic': 'sarah_20260326_091515.txt',
    'dani': 'dani_20260325_042010.txt',
    'amy': 'amy_20260328_164341.txt',
    'james': 'james_20260324_031005.txt',
    'luke': 'luke_20260323_080515.txt',
    'claire': 'claire_20260322_074520.txt',
    'taylor': 'taylor_20260327_152210.txt',
...
def rebuild():
    print("🚀 Rebuilding agents.yaml (FINAL RECOVERY)...")
    
    # Slugs in official Hub order
    slugs = ['morgan', 'sarah-netic', 'dani', 'amy', 'james', 'luke', 'claire', 'taylor', 'michael']
    
    # Hand-verified logs for each slug
    FILES = {
        'morgan': 'morgan_20260327_173848.txt',
        'sarah-netic': 'sarah_20260326_091515.txt',
        'dani': 'dani_20260325_042010.txt',
        ...
        if slug == 'taylor':
            ...
            if os.path.exists(path):
                with open(path, 'r', encoding='utf-8') as f:
                    content = f.read()
                # Persona is everything before Evaluation Results
    ...
    final_content = "agents:\n" + "\n".join(rebuilt_blocks)
    
    with open(AGENTS_PATH, 'w', encoding='utf-8') as f:
        f.write(final_content)
    
    print(f"✨ SUCCESS: agents.yaml reconstructed (~4600 lines)")
