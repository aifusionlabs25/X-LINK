...
def rebuild():
    print("🚀 Rebuilding agents.yaml from history (Take 2)...")
    
    # Correct slug to history file mapping
    FILES = {
        'morgan': 'morgan_20260327_111522.txt',
        'sarah-netic': 'sarah_20260326_091515.txt',
        'dani': 'dani_20260325_042010.txt',
    ...
    for slug, filename in FILES.items():
        ...
        if os.path.exists(path):
            ...
            # Special case: taylor uses the NEW persona provided by the user
            if slug == 'taylor':
    ...
    print(f"✨ SUCCESS: agents.yaml reconstructed.")
